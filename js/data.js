...
const PRODUCTS = [
  ...
  // ---- generate-data-entry.js additions (2026-09-13) ----
  { brand: "ABB", model: "DC522", series: "AC500", cat: "controllers", spec: "AC500 series S500 digital I/O module, 16 configurable DI/DO channels, 24VDC/0.5A", status: "instock", photo: null, linkedin: null, sell_price: 211.35, sell_price_currency: "USD", price_source: "procurement_quote_min" }, // generate-data-entry.js <- wiki/marketing/ABB/PLC/DC522/营销素材包/04-独立站内容包/DC522.md
  { brand: "ABB", model: "DI524", series: "AC500", cat: "controllers", spec: "AC500 series S500 digital input module, 32 DI channels, 24VDC, 1-wire", status: "instock", photo: null, linkedin: null, sell_price: 318.29, sell_price_currency: "USD", price_source: "web_ref" }, // generate-data-entry.js <- wiki/marketing/ABB/PLC/DI524/营销素材包/04-独立站内容包/DI524.md
